...
%%%    一审  normalized %%%
% load('D:\expData\monitorTest\monitorTest_20170425\CRT\lnx\CRT-CR-whit.mat')
% centerMax=allepochedData(:,:,5);
% max(centerMax(:))=85.175;

for iTrial=1:numel(foundMarkers)
	H(iTrial)=plot(beplotedX,epochedData(:,iTrial));  % /85.175
...
% plot(beplotedX,meanEpochedData/85.175,'lineWidth',1,'color',[0.7 0 0]);
