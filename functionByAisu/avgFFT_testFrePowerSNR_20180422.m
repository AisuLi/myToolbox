...
save(['avgFFT_mergeAllconFindChan_-500To1200','noldr_skip' num2str(snrskipNum)]); 
...
% average SNR of max 5chans for 8Hz & 20 Hz 
SNR_820=[squeeze(mean(MaxChanSNR_SNR(freTimePoint(1),:,:,1),2)) squeeze(mean(MaxChanSNR_SNR(freTimePoint(2),:,:,2),2))];
...
% topo of subAvgSNR
validSubNum  = [1:3,5:7,9:11,13:18,20,21];
[myColormap] = makeColormap(20,0,1,'r');
subplot(1,2,1);
...
clearvars -except chooseChanPower    chooseChanSNR ;
...
PowerOfSNR_8hz20hz_3Range(:,size(chooseChanSNR,2)+1,:,:,:)                         = mean(PowerOfSNR_8hz20hz_3Range,2);
PowerOfSNR_8hz20hz_3Range(:,:,size(chooseChanSNR,1)+1,:,:)                         = mean(PowerOfSNR_8hz20hz_3Range,3);
PowerOfSNR_8hz20hz_3Range(:,:,:,:,size(allFrePointPowerMinusBase_4con_3Range,5)+1) = mean(PowerOfSNR_8hz20hz_3Range,5);
...
% fre * chan * sub * con * timeBin 
SNR_201To700 = squeeze(SNR_merge820_3Range(3,end,:,:,1));
SNR_701To1200 = squeeze(SNR_merge820_3Range(3,end,:,:,2));
...
% SNR_8hz20hz_2Range(:,:,:,:,size(allFrePointSNRMinusBase_4con_2Range,5)+1)          = mean(SNR_8hz20hz_2Range,5);

% PowerOfSNR_8hz20hz_2Range(3,:,:,:,:)                                               = mean(PowerOfSNR_8hz20hz_2Range,1);
% PowerOfSNR_8hz20hz_2Range(:,size(chooseChanSNR,2)+1,:,:,:)                         = mean(PowerOfSNR_8hz20hz_2Range,2);
% PowerOfSNR_8hz20hz_2Range(:,:,size(chooseChanSNR,1)+1,:,:)                         = mean(PowerOfSNR_8hz20hz_2Range,3);
% PowerOfSNR_8hz20hz_2Range(:,:,:,:,size(allFrePointPowerMinusBase_4con_2Range,5)+1) = mean(PowerOfSNR_8hz20hz_2Range,5);
...
SNR_merge820_2Range = SNR_8hz20hz_2Range(:,:,[1:3,5:7,9:11,13:18,20,21],:,:);

for iFre = 1:size(SNR_merge820_2Range,1)
	...
	for iTimeRange = 1:size(SNR_merge820_2Range,5)
	 	...
	 	for  iChan = 1:size(SNR_merge820_2Range,2)
	 		...
	 		for iCmp = 1:3
	 			...
	 			[H,pvalue_SNR_merge820_2Range(iCmp,iChan,iTimeRange,iFre),CI] = ttest(squeeze(SNR_merge820_2Range(iFre,iChan,:,4,iTimeRange)), squeeze(SNR_merge820_2Range(iFre,iChan,:,iCmp,iTimeRange)));
...
PowerOfSNR_merge820_2Range = PowerOfSNR_8hz20hz_2Range(:,:,[1:3,5:7,9:11,13:18,20,21],:,:);

for iFre = 1:size(PowerOfSNR_merge820_2Range,1)
	...
	for iTimeRange = 1:size(PowerOfSNR_merge820_2Range,5)
	 	...
	 	for  iChan = 1:size(PowerOfSNR_merge820_2Range,2)
	 		...
	 		for iCmp = 1:3
	 			...
	 			[H,pvalue_PowerOfSNR_merge820_2Range(iCmp,iChan,iTimeRange,iFre),CI] = ttest(squeeze(PowerOfSNR_merge820_2Range(iFre,iChan,:,4,iTimeRange)), squeeze(PowerOfSNR_merge820_2Range(iFre,iChan,:,iCmp,iTimeRange)));
...
SNR_8hz20hz_2Range800(:,:,:,:,size(allFrePointSNRMinusBase_4con_2Range800,5)+1)          = mean(SNR_8hz20hz_2Range800,5);

PowerOfSNR_8hz20hz_2Range800(3,:,:,:,:)                                               = mean(PowerOfSNR_8hz20hz_2Range800,1);
PowerOfSNR_8hz20hz_2Range800(:,size(chooseChanSNR,2)+1,:,:,:)                         = mean(PowerOfSNR_8hz20hz_2Range800,2);
PowerOfSNR_8hz20hz_2Range800(:,:,size(chooseChanSNR,1)+1,:,:)                         = mean(PowerOfSNR_8hz20hz_2Range800,3);
PowerOfSNR_8hz20hz_2Range800(:,:,:,:,size(allFrePointPowerMinusBase_4con_2Range800,5)+1) = mean(PowerOfSNR_8hz20hz_2Range800,5);
...
clear SNR_merge820_2Range800 pvalue_SNR_merge820_2Range800
clear SNR_merge820_2Range800 pvalue_SNR_merge820_2Range800
clear SNR_merge820_2Range800800 pvalue_SNR_merge820_2Range800800


SNR_merge820_2Range800 = SNR_8hz20hz_2Range800(:,:,[1:3,5:7,9:11,13:18,20,21],:,:);

for iFre = 1:size(SNR_merge820_2Range800,1)
	...
	for iTimeRange = 1:size(SNR_merge820_2Range800,5)
	 	...
	 	for  iChan = 1:size(SNR_merge820_2Range800,2)
	 		...
	 		for iCmp = 1:3
	 			...
	 			[H,pvalue_SNR_merge820_2Range800(iCmp,iChan,iTimeRange,iFre),CI] = ttest(squeeze(SNR_merge820_2Range800(iFre,iChan,:,4,iTimeRange)), squeeze(SNR_merge820_2Range800(iFre,iChan,:,iCmp,iTimeRange)));
...
clear PowerOfSNR_merge820_2Range800 pvalue_PowerOfSNR_merge820_2Range800
clear PowerOfSNR_merge820_2Range800 pvalue_PowerOfSNR_merge820_2Range800
clear PowerOfSNR_merge820_2Range800800 pvalue_PowerOfSNR_merge820_2Range800800


PowerOfSNR_merge820_2Range800 = PowerOfSNR_8hz20hz_2Range800(:,:,[1:3,5:7,9:11,13:18,20,21],:,:);

for iFre = 1:size(PowerOfSNR_merge820_2Range800,1)
	...
	for iTimeRange = 1:size(PowerOfSNR_merge820_2Range800,5)
	 	...
	 	for  iChan = 1:size(PowerOfSNR_merge820_2Range800,2)
	 		...
	 		for iCmp = 1:3
	 			...
	 			[H,pvalue_PowerOfSNR_merge820_2Range800(iCmp,iChan,iTimeRange,iFre),CI] = ttest(squeeze(PowerOfSNR_merge820_2Range800(iFre,iChan,:,4,iTimeRange)), squeeze(PowerOfSNR_merge820_2Range800(iFre,iChan,:,iCmp,iTimeRange)));
